...
type UserService interface {
	...
	UpdateUser(ctx context.Context, id int64, req types.UpdateUserRequest) error

	UpdateUserPassword(ctx context.Context, id int64, req types.UpdateUserPasswordRequest) error
