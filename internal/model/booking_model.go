...
type Booking struct {
	...
	SourceID           int64     `gorm:"type:bigint" json:"source_id"`

	Source     *Source       `gorm:"foreignKey:SourceID;references:ID;constraint:fk_bookings_source,OnUpdate:CASCADE,OnDelete:RESTRICT" json:"source"`
...
type Source struct {
	ID   int64  `gorm:"type:bigint;primaryKey" json:"id"`
	Name string `gorm:"type:varchar(50);not null;uniqueIndex:sources_name_key" json:"name"`

	Bookings []*Booking `gorm:"foreignKey:SourceID;references:ID;constraint:fk_bookings_source,OnUpdate:CASCADE,OnDelete:RESTRICT" json:"bookings"`
}
